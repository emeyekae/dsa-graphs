...
class Graph {
  ...
  // this function accepts a Node instance and adds it to the nodes
  // property on the graph
  addVertex(vertex) {
    this.nodes.add(vertex);
  }

  // this function accepts an array of Node instances and adds them
  ...
  // this function accepts two vertices and updates their adjacent 
  //values to remove the other vertex
  removeEdge(v1, v2) {
